...
const AnnotationCanvas: React.FC<AnnotationCanvasProps> = ({
  ...
  // Reset history when switching tasks
  useEffect(() => {
    setUndoStack([]);
    setRedoStack([]);
  }, [taskId]);
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden" onClick={e => e.stopPropagation()}>
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm"><span className="text-gray-400">호버 객체 선택(다중 누적)</span><span className="text-white font-mono bg-gray-800 px-1.5 rounded">X</span></div>
